...
abstract class AbstractBaseFixtures extends Fixture
{
    ...
    protected function createMany(int $count, string $groupName, callable $factory): void
    {
        for ($i = 0; $i < $count; ++$i) {
            ...
            if (null === $entity) {
                throw new LogicException('Did you return the entity object from your callback to BF::createMany()?');
            }
    ...
    protected function getRandomReference(string $groupName): object
    {
        ...
        if (empty($this->referencesIndex[$groupName])) {
            throw new InvalidArgumentException(sprintf('Found any references saved with group name "%s"', $groupName));
        }
